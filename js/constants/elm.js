...
const HC_TITLE = {
	...
	noDC: "无法购买黑暗核心",
	noIU: "无法购买无限升级",
	spaceon: "强制进行天奥挑战(设为0则失效)",
	solaris: "强制进行索拉里斯挑战(设为0则失效)",
	infinity: "强制进行无限挑战(设为0则失效)",
	eternity: "强制进行永恒挑战(设为0则失效)",
	reality: "强制进行现实挑战(设为0则失效)",
	drigganiz: "强制进行德里格尼兹挑战(设为0则失效)",
	flamis: "强制进行弗拉米斯挑战(设为0则失效)",
	cranius: "强制进行克劳尼乌斯挑战(设为0则失效)",
	spectra: "强制进行光谱挑战(设为0则失效)",
	aqualon: "强制进行阿奎纶挑战(设为0则失效)",
	nullum: "强制进行无效化挑战(设为0则失效)",
	quantron: "强制进行康诚挑战(设为0则失效)",
	noGems: "无法获得幽冥宝石",
	purge: "强制进行净化",
	noDS: "导数变换失效",
	noDB: "导数提升失效",
	tv: "强制进入学说宇宙深度(设为-1则失效)",
}
