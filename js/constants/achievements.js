const ACH_DATA = {
	...
	descs: {
		...
		131: "进行基本重置。",
		132: "在难度6级的 现实 竞技场挑战中，未在当前无限中购买无限8;8的前提下，进行净化并到达到达formatDistance(1e15)。",
	...
	rewards: {
		...
		153: "boolean(extreme+hikers_dream,使折算的认可延迟出现的学说树升级也使超级折算的认可延迟出现，但效果较低，只有原来的十分之一)",
		154: "净化能量获取量翻倍boolean(hikers_dream,，且解锁第27个和第28个能量升级)。",
		157: "所有弦的获取量翻倍。",
		...
		171: "拓展泡沫不再消耗它本身，量子泡沫获取量变为10倍，亚普朗克泡沫获取量变为20倍，子空间泡沫获取量变为30倍，依此类推boolean(hikers_dream,，且解锁第29个和第30个能量升级)",
