const ACH_DATA = {
	...
	rewards: {
		...
		142: "自动购买的认可不再重置任何东西。",
		143: "boolean(extreme+hikers_dream,您可以使用Shift键+点击来最大化购买学说树升级，比普通的升级更高效。)boolean(hikers_dream,被动能量的获取量变为一千万倍。)",
		...
		162: "根据未花费的学说点数数值，使所有类型的泡沫效果变得更好boolean(extreme+hikers_dream,。,，您可以使用Shift键+点击来最大化购买学说树升级，比普通的升级更高效。)",
		163: "每秒获得当前产量10%的纠缠弦。",
		166: "解锁自动光子升级和自动胶子升级。",
		168: "解锁自动学说树升级。",
