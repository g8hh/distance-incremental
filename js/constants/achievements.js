const ACH_DATA = {
	...
	rewards: {
		...
		65: "残骸获取量增加showNum(40)%boolean(extreme+hikers_dream,，每个病原体升级使 信心 升级软上限增加三分之一)boolean(hard,，且病原体升级软上限延迟5次)",
		66: "boolean(extreme+hikers_dream,加强 推进器 III 升级的效果，且根据煤数值，加强 优化 升级的效果。)",
		67: "时间加快showNum(11.11)%boolean(extreme+hikers_dream,，且 优化 升级软上限延迟5次， 信心 升级软上限延迟1次)。",
