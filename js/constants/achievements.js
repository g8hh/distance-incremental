const ACH_DATA = {
	...
	rewards: {
		...
		35: "加速度showNum(80)%boolean(extreme,，且煤的效果翻倍)。",
		...
		65: "残骸获取量增加showNum(40)%boolean(extreme+hikers_dream,，每个病原体升级使 信心 软上限增加三分之一)boolean(hard,，且病原体升级软上限延迟5次)",
		66: "boolean(extreme+hikers_dream,加强 推进器 III 的效果，且根据煤的数值，加强 优化 的效果。)",
		67: "时间加快showNum(11.11)%boolean(extreme+hikers_dream,，且 优化 软上限延迟5次， 信心 软上限延迟1次)。",
		68: "病原体获取量变为showNum(2.5)倍boolean(hard+hikers_dream,，根据 信心 数值，增加病原体获取量)boolean(extreme,，且残骸获取量变为5倍)。",
