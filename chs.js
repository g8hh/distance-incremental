...
var cnItems = {
    ...
    '\'The Universe Doesnt Exist\' reward is stronger based on your Elementaries.': '根据基本重置次数，使“宇之不存”成就的效果变得更好。',
    ...
    'Raise Optimization effect to the power of the number of Higgs Boson upgrades and energy multiples Knowledge gain.': '将 优化 升级的效果变为一个数值的幂，此数值为希格斯玻色子升级数量，且使知识的获取量乘以能量的数值。',
