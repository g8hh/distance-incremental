...
var cnItems = {
    ...
    'Your Best Hadronic Score powers Optimization I and multiplies hadron gain': '您最高的强子分数使优化 I的效果变为原来的某个指数，并使强子获取量乘以相应数值',
    ...
    'Unlock Auto-Spectral Gem Distribution, you keep Purge Power on reset, and super energy multiplies photons gain.': '解锁自动幽冥宝石，重置时保留净化能量，且根据超级能量的数值，使光子获取量乘以相应数值。',
    ...
    'Keep Stadium Challenges on reset, and Elementary Particle gain & Higgs Boson gain are increased by 10% for each Higgs Upgrade bought.': '重置时保留竞技场挑战，且每购买一个希格斯升级，基本粒子获取量和希格斯玻色子获取量就增加10%。',
    'Unlock Auto-Derivative Shifts/Boosts, Auto-Endorsements buy max, and you gain Knowledge 200% faster.': '解锁自动导数变换/提升，自动认可能够最大化进行购买，知识获取量翻倍。',
    ...
    'Knowledge gain & Ascension Power gain are faster based on the Perk Accelerator\'s speed.': '根据特权加速器的速度数值，增加知识获取量和飞升能量获取量。',
    ...
    'Gain 666x more Gluons.': '胶子获取量变为原来的666倍。',
    ...
    'Raise Optimization effect to the power of the number of Higgs Boson upgrades and energy multiples Knowledge gain.': '将 优化 升级的效果变为一个数值的幂，此数值为希格斯玻色子升级数量，且根据能量数值，使知识获取量乘以相应数值。',
