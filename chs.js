...
var cnItems = {
    ...
    'Unlock Auto-Spectral Gem Distribution, you keep Purge Power on reset, and super energy multiplies photons gain.': '解锁自动幽冥宝石，重置时保留净化能量，且根据超级能量的数值，使光子的获取量乘以相应数值。',
    ...
    'You start with 10 Endorsements on reset.': '重置时直接获得10认可。',
    ...
    'Pathogen Upgrades are stronger (unaffected by softcap).': '病原体升级效果变得更好(不受软上限影响)。',
    'Graviton Boosts are stronger.': '引力子加成效果变得更好。',
    ...
    'The "Time Doesnt Exist" effect is raised to an exponent.': '“时骨无存”的效果变为某个数值的幂。',
    'The Entropy effect is raised to an exponent.': '熵的效果的效果变为某个数值的幂。',
    ...
    'Pathogen Upgrade 1\'s effect is multiplied.': '病原体升级 1的效果变为相乘。',
    'Gauge Speed is raised to an exponent.': '规范作用力产生资源的速度变为某个数值的幂。',
    'The Cadaver effect is raised to an exponent.': '残骸的效果变为某个数值的幂。',
    'The Skyrmion effect is multiplied.': '斯格明子的效果变为某个数值的幂。',
    'The Perk Accelerator is stronger based on your Inflatons.': '根据暴胀子数值，使特权加速器变得更强。',
    'The second Inflaton effect is stronger based on your Ascension Power.': '根据飞升能量数值，使暴胀子的第二个效果变得更强。',
    'Dear Player,': '亲爱的玩家，',
