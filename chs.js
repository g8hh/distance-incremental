...
var cnItems = {
    ...
    'Furnace Upgrades are 99.99% weaker, Enhanced Furnace Upgrades are 50% weaker, and Blue Flame & Enhanced Furnace Upgrades cost scale much faster. This challenge forces an Elementary reset instead of a Collapse reset.': '熔炉升级效果减弱99.99%，加强熔炉升级效果减弱50%，蓝色火焰和加强熔炉升级的花费提升速度变得更快。进行此挑战将同时进行一次基本重置，而不是坍缩重置。',
    'Goal': '目标',
    ' Blue Flame': ' 蓝色火焰',
    '': '',
    '': '',
